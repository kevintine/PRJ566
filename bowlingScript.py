...
for round in range(1, 10):
    ...
    for player in range(num_players):
        ...
        roll2 = random.randint(0, 10)  # Random number between 0 and 10 for the second roll
        frame_data = {
            "roll1": roll1,
            "roll2": roll2,
            "score": roll1 + roll2,  # Score is the sum of roll1 and roll2
            "isStrike": False,  # Whether the frame is a strike (not calculated here)
            "isSpare": False,  # Whether the frame is a spare (not calculated here)
        ...
        time.sleep(0.5)  # Add a half-second delay between requests
